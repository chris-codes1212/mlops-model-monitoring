...
Each of these repositories, api and monitoring, contains their own unique dockerfiles to run the api and monitoring applications seperately, however their is a Makefile in the root directory which will build and run containers for the api and monitoring applications.
